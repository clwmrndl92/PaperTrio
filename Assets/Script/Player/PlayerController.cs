...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //if (((input.buttonsDown & InputData.LANDBUTTON) == InputData.LANDBUTTON) && ground.GetOnLandingDashGround() && !ground.GetOnGround())
        //{
